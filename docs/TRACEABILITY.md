...
| REQ-IPC-009 | Priority inheritance / donation | ADR-020 | kernel-core/src/priosched.rs; kernel/src/usermode.rs; kernel-riscv64/src/usermode.rs | kernel-core/tests/priosched.rs; kernel/src/usermode.rs; kernel-riscv64/src/usermode.rs | scripts/vm-e2e.sh; scripts/vm-e2e-riscv.sh | delivered |
| REQ-IPC-010 | Blocking IPC (recv blocks, send wakes + delivers, receiver resumes) | ADR-020 | kernel/src/usermode.rs; kernel-riscv64/src/usermode.rs | kernel/src/usermode.rs; kernel-riscv64/src/usermode.rs | scripts/vm-e2e.sh; scripts/vm-e2e-riscv.sh | delivered |
