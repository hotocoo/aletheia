...
| REQ-SMP-001 | SMP / multicore (umbrella: per-CPU scheduling, TLB shootdown, lock audit) | ADR-021 | kernel/src/smp.rs; kernel-riscv64/src/smp.rs; kernel-x86_64/src/smp.rs | kernel/src/smp.rs | scripts/vm-e2e.sh | partial |
