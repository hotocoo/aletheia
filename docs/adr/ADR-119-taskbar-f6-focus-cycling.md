...
to the next taskbar affordance using the same canonical wrapping order as forward Tab/right-arrow
navigation. Escape remains the explicit way to leave the mode.
