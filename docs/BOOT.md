...
+ 33 virtual-memory + 22 EL0 user-mode + 5 virtio-blk + 22 SMP** invariants (incl. cap-gated `svc`
...
Gated: **11 spine + 17 memory + 33 virtual-memory + 22 U-mode boundary + 22 SMP** invariants (full
...
8259 PIC + 8254 PIT, and re-proves **11 spine + 17 memory + 25 virtual-memory + 22 ring-3
