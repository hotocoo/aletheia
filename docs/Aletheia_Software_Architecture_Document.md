...
**Currency:** last reconciled with the tree on 2026-08-02 (ADR list through ADR-034; memory-safety contract in §5).
...
- ADR-033 Erase on free (a freed frame carries nothing).
