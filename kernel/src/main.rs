...
pub extern "C" fn kmain() -> ! {
    ...
    match kernel_core::lethed::lethed_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(620 + idx as i32);
        }
    }
    ...
    match kernel_core::reclaim::reclaim_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(700 + idx as i32);
        }
    }
    {
    ...
    match usermode::selftest() {
        Ok(n) => {
            kprintln!("[usermode] ALL {} EL0-BOUNDARY INVARIANTS HOLD", n);
            kprintln!(
    ...
    match kernel_core::tcp::tcp_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(720 + idx as i32);
        }
    }
    ...
    match kernel_core::x25519::x25519_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(800 + idx as i32);
        }
    }
    ...
    match kernel_core::tlshandshake::tlshandshake_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(840 + idx as i32);
        }
    }
    ...
    match kernel_core::content::content_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(1040 + idx as i32);
        }
    }
    ...
    match kernel_core::dns::dns_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(1060 + idx as i32);
        }
    }
    ...
    match kernel_core::browser::browser_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(1020 + idx as i32);
        }
    }
    ...
    match kernel_core::http::http_suite(|n, passed, name| {
        ...
        Err((idx, name)) => {
            ...
            semihosting::exit(1000 + idx as i32);
        }
    }
        ...
        Some(Ok(mut gpu)) => {
            ...
            // The freeing heap's contract (ADR-198), over a scratch region lent from the heap.
            {
                ...
                match unsafe {
                    ...
                    Err((idx, name)) => {
                        ...
                        semihosting::exit(1090 + idx as i32);
                    }
                }
            }
            ...
            match kernel_core::edid::edid_suite(|n, passed, name| {
                ...
                Err((idx, name)) => {
                    ...
                    semihosting::exit(1080 + idx as i32);
                }
            }
    ...
    match smmu::suite(&mut |n, passed, name| {
        ...
        Ok(0) => {}
        Ok(n) => {
            kprintln!("[smmu] ALL {} SMMUV3 INVARIANTS HOLD", n);
            kprintln!(
                "[boot] smmu suite: {} ms",
                kernel_core::boottime::lap::<ActiveHal>("smmu")
            );
        }
        Err((idx, name)) => {
