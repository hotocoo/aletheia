...
AARCH64_EXPECTED="bench=12 cap=14 compositor=14 conring=9 console=42 dma=9 fbcon=6 fs=15 gpu=13 iommu=9 keys=12 lethe=12 lethed=15 mlrisk-stress=8 mlrisk=22 mlsched=12 mm=21 net=9 persist=10 pm=14 selftest=13 smp=22 soak=12 usermode=32 smmu=10 vault=14 virtio=21 vm=66"
