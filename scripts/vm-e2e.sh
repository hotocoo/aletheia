...
AARCH64_EXPECTED="bench=12 cap=14 compose=8 compositor=14 conring=9 console=44 dma=9 fbcon=6 fs=15 fsstorm=5 linebuf=4 shellstorm=4 gpu=13 input=13 iommu=9 keys=12 mlrisk-stress=8 mlrisk=22 mlsched=17 mm=21 net=9 persist=10 pm=14 reclaim=9 selftest=13 smp=22 soak=12 filepanel=13 persona=8 textgrid=7 schedstorm=5 wm=14 wmstorm=6 usermode=32 smmu=10 vault=14 vinput=10 virtio=21 vm=66"
